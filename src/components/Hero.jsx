...
export default function Hero() {
  ...
  return (
    <main className="relative z-10 flex-1 flex flex-col items-center px-4 md:px-6 w-full pb-[6vh] md:pb-[8vh]">
      ...
      <div className="absolute left-1/2 -translate-x-1/2 top-[calc(5vh-5px)] min-[768px]:top-[calc(12vh-145px)] min-[820px]:top-[calc(12vh-120px)] xl:top-1/2 xl:-translate-y-1/2 xl:-mt-[38vh] w-fit max-w-[95vw] xl:max-w-[1400px] flex flex-col items-center p-[clamp(20px,1.04vw,50px)] text-center scale-[1.2] min-[768px]:scale-[1.53] min-[820px]:scale-[1.8] xl:scale-100 origin-top xl:origin-center">
        ...
        <div className="flex flex-col items-center min-[2560px]:translate-y-[20px]">
          ...
          <motion.div 
            ...
            className="inline-flex mb-2 md:mb-8 md:translate-y-[10px] xl:translate-y-0 cursor-default"
          >
            <div className="py-[clamp(6px,0.31vw,12px)] px-[clamp(12px,1.04vw,40px)] flex items-center justify-center">
              <span className="text-[#804B5A] text-[clamp(10px,0.65vw,53px)] md:text-[16px] xl:text-[clamp(10px,0.65vw,53px)] font-sans font-semibold tracking-[0.1em] uppercase">
                Featured UI/UX Work
              </span>
            </div>
          </motion.div>
      ...
      <div className="flex flex-col items-center mt-auto w-full max-w-3xl px-4 md:px-8">
        <motion.div
          ...
          className="w-full flex justify-center md:scale-[1.8] xl:scale-100 md:translate-y-[85px] xl:translate-y-0"
        >
          <motion.button 
            initial="initial"
            whileHover="hover"
        ...
        <motion.p 
          ...
          className="font-sans text-white/95 w-full text-center text-[clamp(14px,0.83vw,32px)] md:text-[22px] xl:text-[clamp(14px,0.83vw,32px)] md:leading-[1.6] xl:leading-relaxed leading-relaxed [text-shadow:0_4px_16px_rgba(128,75,90,0.85)] mt-4 md:mt-24 xl:mt-4 px-4"
        >
          {/* MOBILE ONLY */}
          ...
          {/* DESKTOP ONLY */}
          <span className="hidden xl:inline landscape:whitespace-nowrap">
            I design intuitive UI/UX for web, apps, SaaS dashboards and cross-platform setups. <br />
            Elevating your brand with cohesive VI and identity design.
          </span>
        </motion.p>
