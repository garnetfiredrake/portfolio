      ...
      <div className="absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 -mt-[310px] md:top-[-10px] md:translate-y-0 md:mt-0 w-fit max-w-[95vw] xl:max-w-[1400px] flex flex-col items-center p-[20px] text-center">
        ...
        <div className="flex flex-col items-center">
          ...
          <motion.div 
            ...
            className="inline-flex rounded-full bg-white/50 backdrop-blur-md border border-white/60 p-[clamp(2px,0.2vw,8px)] mb-[clamp(16px,1.25vw,48px)] transition-colors hover:bg-white/70 cursor-default shadow-[0_2px_15px_rgba(0,0,0,0.05)]"
          >
          ...
          {/* Dynamic Headline */}
          <h1 className="text-center flex flex-col items-center justify-center mb-0 w-full -translate-y-[40px]">
            <span className="font-serif italic text-white text-[clamp(24px,5vw,128px)] leading-none whitespace-nowrap inline-flex">
