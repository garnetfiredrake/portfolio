export default function Navbar() {
  return (
    <nav className="relative z-30 flex justify-between items-center px-6 md:px-10 py-6 w-full">
      <div className="text-white flex items-center opacity-25">
        <svg viewBox="0 0 800 500" xmlns="http://www.w3.org/2000/svg" className="w-[80px] md:w-[120px] lg:w-[80px] h-auto fill-white stroke-white stroke-[0.25]">
