...
export default function Footer() {
  ...
  return (
    <footer className="relative z-10 w-full flex flex-col justify-between px-4 md:px-8 pt-16 md:pt-[56px] xl:pt-32 pb-8 bg-black/60 backdrop-blur-sm border-t border-white/10">
      ...
      <div className="w-full max-w-screen-2xl mx-auto flex flex-col xl:flex-row justify-between items-start xl:items-end mb-16 gap-12">
        ...
        {/* Epic Giant Text */}
        <h2 className="font-sans text-[clamp(48px,12vw,240px)] md:text-[19.5vw] xl:text-[clamp(48px,12vw,240px)] leading-[0.8] font-bold text-white tracking-tighter uppercase relative w-fit mb-0">
